...
public class AllyMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _text[0] = transform.Find("Upper_Item_I").gameObject;
        _text[1] = transform.Find("Right_Item_I").gameObject;
        _text[2] = transform.Find("Lower_Item_I").gameObject;
        _text[3] = transform.Find("Left_Item_I").gameObject;
